...
def ap_detail(html, source_url=None):
    ...
    # ONLY the main-listing gallery. Cut the page at the first "promoted/partner ads" or "related
    # announcements" block (class="promoted-announcement" data-type="partnerads", inside
    # related-announcements-items-container / js-other-partner-anns) -> those are OTHER cars.
    _cut=len(html)
