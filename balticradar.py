...
def ap_detail(html, source_url=None):
    ...
    country="LT"   # FLAG = SOURCE PORTAL: autoplius is the Lithuanian marketplace -> always LT. The real city/country still shows in `location` above (e.g. "Rīga, Latvija" for LV dealers listing on lv.autoplius.lt).
...
def a24_posted(html):
    ...
    if m:
        ...
        return baltic_to_utc_iso(y,mo,d,H,Mi,S)     # auto24 prints LOCAL Estonian time
